...
urlpatterns = [
    ...
    path('admin', views.AdminProductListView.as_view(), name='admin_product_list'),
    path('<int:pk>', views.ProductDetailView.as_view(), name='product_details'),
    path('admin/<int:pk>', views.AdminProductDetailView.as_view(), name='admin_product_details'),
    ...
    path('admin/create', views.ProductCreateView.as_view(), name='product_create'),
    path('admin/update/<int:pk>', views.ProductUpdateView.as_view(), name='update_product'),
