...
from .views import admin_list_products, catalog_list_products, admin_product_details, catalog_product_details, admin_create_product, admin_edit_product, admin_delete_product
